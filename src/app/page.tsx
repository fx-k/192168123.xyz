  ...
  return (
    <>
      <div className="prose-container">
        ...
        <p className="mt-4 break-words leading-loose">
          本是个开<Link className="underline decoration-sky-500" href="https://mc.fxit.top/" target="_blank">MC服</Link>出身的腐竹🤔意外间打开了CS领域的大门，并开始在前后端及计网运维等领域<a className='line-through'>摸爬滚打</a>😳...后来，有幸正式成为了科班出生的计机人，目前已经是个硕士研究生😎
        </p>
        <p className="mt-4 break-words leading-loose">
